...
#define STRING_CONFIG_H_AUTHOR "(S.D.S.T.V.O.)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sail"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // E3D V6 with block&sock
  #define  DEFAULT_Kp 14.43
  #define  DEFAULT_Ki 0.96
  #define  DEFAULT_Kd 54.07
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  */
  //TEVO Tarantula Medusa Settings 70C - Large Heatbed with 4mm borosilicate
	#define  DEFAULT_bedKp 228.37
	#define  DEFAULT_bedKi 42.89
	#define  DEFAULT_bedKd 304.02	
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 225, 225, 3, 60 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 600, 100, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 10, -0.6 }
